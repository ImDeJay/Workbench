...
public class MaterialDatabase {
    ...
    public ItemData matchItem (String input, boolean blocks, boolean items) {
        ...
        return ItemData.fromStack(new ItemStack(id, 1, (short) data));
    }

    public String getName (ItemData data, int... amount) {
        return this.getName(data.getID(), data.getID(), amount.length > 0 ? amount[0] : 1);
    }
